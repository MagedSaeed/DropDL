...
interface AuthContextType {
  user: User | null
  loading: boolean
  apiCall: <T = unknown>(method: Method, url: string, data?: unknown, config?: AxiosRequestConfig) => Promise<AxiosResponse<T>>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const apiCall = useCallback(<T = unknown>(method: Method, url: string, data?: unknown, config?: AxiosRequestConfig) => {
    return axios<T>({
      method,
